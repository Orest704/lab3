        ...
        LazyColumn(
            ...
            item {
                val imageID = when (item.image) {
                    "grotpryjma" -> R.drawable.grotpryjma
                    "kamyaneczkyjvodospad" -> R.drawable.kamyaneczkyjvodospad
                    "rozgirche" -> R.drawable.rozgirche
                    "tustan" -> R.drawable.tustan
                    "zamokurch" -> R.drawable.zamokurch
                    "zolochivskyjzamok" -> R.drawable.zolochivskyjzamok
                    else -> R.drawable.grotpryjma
                }
                Image(
